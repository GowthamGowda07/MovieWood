...
const Reviews = ({id, prevRating, userRated}) => {
    ...
    const sendReview = async () => {
        ...
        await updateDoc(ref,{                            // to update document of movie collection with ratin and rated
    ...
    return (
        ...
        <div>
            {data.map((e,i) => {
                return(<div className =' p-2 w-full border-b header bg-opacity-50 border-gray-600 mt-2' key = {i}>
